...
yes | pacman -S plasma-wayland-session dolphin dolphin-plugins kio5 kio-admin kio-extras kio-fuse kio-zeroconf kfind konsole spectacle okular gwenview kate print-manager cups system-config-printer \
...
kamoso kdf kcachegrind krfb kbackup kwallet5 kwalletmanager kdeconnect firefox firefox-i18n-pt-br gst-plugin-va gst-plugins-bad docker docker-compose vlc qbittorrent kde-graphics  \
unrar unzip p7zip mesa ark lm_sensors i2c-tools libvdpau-va-gl libva-vdpau-driver libva-utils vdpauinfo vulkan-radeon amdvlk mesa-utils ntfs-3g dosfstools exfat-utils btrfs-progs tailscale zerotier-one git wget curl \
